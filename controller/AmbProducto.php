...
class AbmProducto
{
    //Espera como parametro un arreglo asociativo donde las claves coinciden con los prodetalles de las variables instancias del objeto
    ...
    /**
     * Espera como parametro un arreglo asociativo donde las claves coinciden con los prodetalles de las variables instancias del objeto que son claves
     * @param array $param
     * @return Producto
     */
    ...
    public function modificacion($param)
    {
        ...
        if ($this->seteadosCamposClaves($param)) {
            $buscar2 = array();
            $buscar2['idproducto'] = $param['idproducto'];
            $elProducto = $this->buscar($buscar2);
            if ($elProducto != null) {
                $elProducto[0]->setpronombre($param['pronombre']);
