...
<main>
    <div class="row mb-5">
        ...
        <form id="productosCargados" name="productosCargados" action="actualizarProducto.php" method="POST">
                    ...
                    if (count($listaTabla) > 0) {
                        ...
                        foreach ($listaTabla as $objProducto) {
                            ...
                            <td class="text-center">
                                <button class="btn btn-success btn-sm" type="submit" value="' . $id . '" id="proEdit" name="proEdit" role="button">
